...
@section('contenido')
<h1 class="display-4 text-center">AQUI PODRAS ACTUALIZAR </h1> <hr><hr><hr>
    ...
    <div class="container">
        <div class="col mt-4">
            <form action="{{route('personas.update', $personas)}}" method="post">
                ...
                <button type="submit" class="btn btn-danger display-4 text-center">Actualizar los datos</button>
            </form>
        </div>
    </div>
</div>
